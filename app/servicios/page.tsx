    ...
    <>
      ...
      <JsonLdStructuredData
        ...
        data={{
          ...
          description:
            'Proceso completo de 12 semanas para desarrollar equipos tecnológicos autosuficientes',
          steps: [
            {
              '@type': 'HowToStep',
      ...
      <JsonLdStructuredData
        ...
        data={{
          title: 'Servicios de Coaching y Consultoría | ELEVA CONSULTORIA',
          description:
            'Servicios especializados en coaching de liderazgo, consultoría agile y transformación organizacional.',
          breadcrumb: 'Servicios',
        }}
        pathname="/servicios"
      />
