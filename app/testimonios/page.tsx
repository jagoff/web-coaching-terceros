...
export const metadata: Metadata = {
  ...
  description:
    'Descubre los testimonios de clientes y casos de éxito de nuestro coaching. Líderes tech y startups que han transformado sus equipos y culturas organizacionales.',
  keywords: [
  ...
  openGraph: {
    title: 'Testimonios | Casos de Éxito | ELEVA CONSULTORIA',
    description:
      'Descubre los testimonios de clientes y casos de éxito de nuestro coaching profesional.',
    type: 'website',
    locale: 'es_ES',
