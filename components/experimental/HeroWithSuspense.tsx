    ...
    <HeroSuspense>
      ...
      >
        ...
        <div className="container relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-16">
          ...
          >
            {/* Main heading */}
            <h1 className="heading-xl mb-6 sm:mb-8" style={{ fontFamily: 'var(--font-heading)' }}>
              {language === 'es' ? (
                <>
                  Transformá tu <span className="text-gradient">liderazgo</span>
                </>
              ) : (
                <>
                  Transform your <span className="text-gradient">leadership</span>
                </>
              )}
            </h1>
