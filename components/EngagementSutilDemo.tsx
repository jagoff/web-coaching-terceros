...
function ConfianzaProfesionalSection() {
  ...
  return (
    <section ref={ref} className="min-h-screen flex items-center justify-center relative">
      <motion.div className="container mx-auto px-8 text-center" style={{ y, opacity }}>
        <motion.h2
        ...
        >
          ...
          <br />
          <span className="text-3xl md:text-4xl font-light text-gray-400/70 italic">
            Profesional
          </span>
        </motion.h2>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
            Cada detalle está cuidadosamente diseñado. Desde la tipografía hasta los espacios en
            blanco, todo comunica excelencia y atención al detalle.
          </motion.div>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16">
            {['Precisión', 'Claridad', 'Elegancia'].map((word, index) => (
              ...
              >
                ...
                <div className="text-lg font-light text-gray-300/80">{word}</div>
                <motion.div
    ...
    <section className="min-h-screen flex items-center justify-center">
      <div className="container mx-auto px-8">
        ...
        <div className="max-w-2xl mx-auto text-center space-y-16">
          ...
          >
            El espacio en blanco no es espacio vacío. Es espacio para respirar, para pensar, para
            procesar.
          </motion.p>
          ...
          >
            Nada compite por tu atención. Cada elemento tiene su propósito y su espacio.
          </motion.p>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="container mx-auto px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-4xl mx-auto">
          {memories.map((memory, index) => (
            ...
            >
              ...
              {/* Título */}
              <h3 className="text-xl font-light text-gray-300/80 mb-3">{memory.title}</h3>
        ...
        >
          Las experiencias que recordamos no son las que vemos, sino las que sentimos.
        </motion.p>
      </div>
    </section>
  )
