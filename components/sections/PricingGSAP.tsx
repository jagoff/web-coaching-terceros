...
export default function PricingGSAP() {
  ...
  return (
    <section id="precios" className="section section-surface section-gold-border-top" ref={sectionRef}>
                ...
                <div className="mb-8">
                  <div className="flex items-baseline mb-4">
                    <span
                      ...
                      style={{ color: "var(--text-primary)" }}
                    >
                      {plan.id === "individual" && language === 'es' ? "Personalizado" : 
                       plan.id === "individual" && language === 'en' ? "Custom" :
                       plan.id === "transformacion" ? "€2.500/mes" :
                       plan.id === "elite" && language === 'es' ? "Elite" : "Elite"}
                    </span>
          ...
          <div className="inline-flex items-center gap-4 p-4 rounded-xl bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)]">
            ...
            <div className="text-left">
              ...
              <p
                ...
                style={{ color: "var(--text-secondary)" }}
              >
                {language === 'es' ? 'Hablemos de tus necesidades específicas' : 'Let\'s discuss your specific needs'}
              </p>
            </div>
            <button
