...
export default function Hero() {
  ...
  const isAlignmentPhrase =
    rotatingPhrases[phraseIndex].includes('alineado') ||
    rotatingPhrases[phraseIndex].includes('aligned')
    ...
    >
      ...
      <div className="container relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          >
            <span
              className="block hero-gradient-1"
              style={{
                backgroundImage:
                  'linear-gradient(135deg, #D4CAD8 0%, #8B7AD2 60%, #ADA0E0 100%) !important',
            ...
            <span
              className="block mt-3 hero-gradient-2"
              data-text={language === 'es' ? 'Liderá con propósito.' : 'Lead with purpose.'}
              style={{
                backgroundImage:
                  'linear-gradient(135deg, var(--text-primary) 0%, var(--gold-primary) 100%) !important',
                backgroundClip: 'text !important',
                WebkitBackgroundClip: 'text !important',
                WebkitTextFillColor: 'transparent !important',
                color: 'transparent !important',
            ...
            <span
              className="block mt-3 hero-gradient-3"
              style={{
                backgroundImage:
                  'linear-gradient(135deg, #D4CAD8 0%, #8B7AD2 40%, var(--gold-primary) 100%) !important',
                backgroundClip: 'text !important',
                WebkitBackgroundClip: 'text !important',
                WebkitTextFillColor: 'transparent !important',
                color: 'transparent !important',
          ...
          >
            <button className="btn-primary animate-glow" onClick={() => handleScroll('#contacto')}>
              {language === 'es' ? 'Agendá tu sesión gratuita →' : 'Book your free session →'}
            </button>
            <button className="btn-secondary" onClick={() => handleScroll('#proceso')}>
