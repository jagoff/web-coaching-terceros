...
import { CheckCircle2, ArrowRight, ChevronLeft, ChevronRight, Sparkles, Target, Zap, Shield } from "lucide-react";
    ...
    <section id="precios" className="section section-surface section-gold-border-top" ref={ref}>
      <div className="container">
          ...
          {plans.map((_, index) => (
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                boxShadow: page === index ? `0 0 20px ${getGradientColors(currentPlan.gradient).start}40` : 'none',
              }}
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl" style={{ height: "600px", perspective: "1200px" }}>
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        clipPath: isActive ? 'none' : Math.abs(offset) === 1 
                          ? offset > 0 
                            ? 'inset(0 0 0 35%)' 
                            : 'inset(0 35% 0 0)'
                          : 'none',
                    ...
                    >
                      ...
                      <div className="h-full flex flex-col justify-between">
                        ...
                        >
                          <div className={`space-y-3 ${isActive ? 'max-w-sm' : 'max-w-xs'} mx-auto`}>
                            {(isActive ? plan.features.slice(0, 4) : plan.features.slice(0, 2)).map((feature: string, featureIndex: number) => (
                              <motion.div
                                key={feature}
                                ...
                                style={{ display: isActive || (Math.abs(offset) === 1 && featureIndex < 2) ? 'flex' : 'none' }}
                              >
                        ...
                        >
                          <button
                            ...
                            style={{ display: isActive || Math.abs(offset) === 1 ? 'inline-flex' : 'none' }}
                          >
                        ...
                        {!isActive && Math.abs(offset) === 1 && (
                          ...
                          >
                            <div className="text-center">
                              ...
                              >
                                <ChevronRight className={`w-6 h-6 text-white ${offset > 0 ? '' : 'rotate-180'}`} />
                              </motion.div>
          ...
          <div className="text-center mt-6">
            <span className="text-sm text-gray-400">
              {language === "es" ? "Plan" : "Plan"} {page + 1} {language === "es" ? "de" : "of"} {plans.length}
            </span>
          </div>
        </div>
