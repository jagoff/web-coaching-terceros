...
export default function Testimonials() {
  ...
  return (
    <section id="testimonios" className="section section-dark" ref={ref}>
      <div className="container">
        ...
        >
          ...
          >
            {t.testimonials.title} <span className="text-gradient">{t.testimonials.title2}</span>
          </motion.h2>
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <span className="text-sm font-bold" style={{ color: 'var(--amber-light)' }}>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    height: 8,
                    background: i === current ? 'var(--gold-primary)' : 'var(--dark-border)',
                  }}
                />
              ))}
            </div>
