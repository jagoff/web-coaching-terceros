  ...
  return (
    <section id="precios" className="section section-surface section-gold-border-top" ref={ref}>
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 lg:gap-12 md:items-stretch mt-6 md:mt-16">
          {plans.map((plan, i) => (
            <motion.div
              key={plan.id}
              custom={i}
            ...
            >
              ...
              <div
                ...
                style={{ minHeight: '1.75rem', transform: 'translateY(-15px)' }}
              >
                {plan.badge && (
                  <span
        ...
        >
          <div className="text-center">
            <p
              className="text-base mb-2 text-center mx-auto"
