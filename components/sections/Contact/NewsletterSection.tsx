...
export default function NewsletterSection() {
  ...
  const benefits = [
    { icon: TrendingUp, text: t.newsletter?.benefits?.[0] || (language === "es" ? "Tips prácticos de leadership moderno" : "Practical tips for modern leadership") },
    { icon: Target, text: t.newsletter?.benefits?.[1] || (language === "es" ? "Recursos ágiles para implementar ya" : "Agile resources to implement now") },
    { icon: Zap, text: t.newsletter?.benefits?.[2] || (language === "es" ? "Noticias y tendencias del mundo tech" : "Tech world news and trends") }
  ];
    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-gray-300 text-sm">
          {t.newsletter?.subtitle || (language === "es" ? "Leadership, recursos ágiles y noticias directamente en tu inbox" : "Leadership, agile resources and news directly in your inbox")}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <input
            ...
            placeholder={t.newsletter?.emailPlaceholder || (language === "es" ? "Tu email profesional" : "Your professional email")}
        ...
        >
          {isSubmitting ? (
            ...
            <>
              ...
              {t.newsletter?.subscribeButton || (language === "es" ? "Suscribirme Gratis" : "Subscribe Free")}
            </>
          )}
        </button>
      </form>
      ...
      <p className="text-xs text-gray-400 text-center mt-4">
        {t.newsletter?.note || (language === "es" ? "Sin spam. Un email mensual con valor real." : "No spam. One monthly email with real value.")}
      </p>
    </motion.div>
  );
}
