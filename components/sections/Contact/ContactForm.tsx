...
import { CheckCircle2, Loader2, CheckCheck, AlertCircle, Send, ArrowRight } from 'lucide-react'
...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus('error')
      mailtoRef.current = createMailtoLink(form)
      setApiError(language === 'es' ? 'Error al enviar mensaje.' : 'Error sending message.')
    }
  }
                ...
                >
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: hasError ? '#ef4444' : isValid ? '#10b981' : '#FF6B35',
                      }}
                    />
          ...
          <div className="pt-4">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, rgba(255, 107, 53, 0.2) 0%, rgba(255, 133, 85, 0.2) 100%)',
                }}
              />
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, rgba(255, 107, 53, 0.3) 0%, rgba(255, 133, 85, 0.3) 100%)',
