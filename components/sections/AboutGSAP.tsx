    ...
    >
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 xl:gap-20 items-center">
          {/* Image column */}
          <div ref={imageColumnRef} className="relative order-2 lg:order-1 mt-4 lg:mt-0">
            {/* Badge */}
          ...
          {/* Text column */}
          <div ref={textColumnRef} className="order-1 lg:order-2">
            <h2
              ref={titleRef}
            ...
            <div ref={credentialsRef} className="flex flex-wrap gap-3 sm:gap-4">
              {Array.from({ length: shuffledCredentials.length + 1 }, (_, index) => {
                ...
                if (isLinkedInButton) {
                  ...
                  return (
                    <div key={shuffledCredentials[credIndex]} className="credential-chip">
                      <CheckCircle2
                        size={14}
