      ...
      <div className="container relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-14 md:mb-20">
          ...
          <h2 ref={titleRef} className="heading-xl" style={{ fontFamily: 'var(--font-heading)' }}>
            {language === 'es'
              ? 'Transformación que habla por sí misma'
        ...
        {/* Carousel */}
        <div ref={carouselRef} className="relative max-w-4xl mx-auto mb-12 md:mb-16">
          <div
            ref={cardRef}
          ...
          {/* Dots */}
          <div ref={navRef} className="flex justify-center gap-2 mb-8">
