...
export default function CaseStudies() {
  ...
  return (
    <section
      id="casos-de-estudio"
      className="section section-surface section-gold-border-top hidden md:block"
      ref={ref}
    >
      <div className="container">
        ...
        >
          ...
          <motion.p variants={blurUp} className="lead-text max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <div className="mb-6 pb-4 border-b" style={{ borderColor: 'rgba(124,107,196,0.2)' }}>
                ...
                <p className="text-xs" style={{ color: 'var(--text-secondary)' }}>
                  <span className="font-semibold">Qué se hizo:</span>{' '}
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h5 className="text-sm font-semibold" style={{ color: '#ef4444' }}>
                    ...
                    {caseStudy.before.points.map((point, idx) => (
                      <li
                        ...
                        style={{
                          ...
                          borderBottom:
                            idx < caseStudy.before.points.length - 1
                              ? '1px solid rgba(124,107,196,0.1)'
                              : 'none',
                    ...
                    {caseStudy.intervention.points.map((point, idx) => (
                      <li
                        ...
                        style={{
                          color: 'var(--text-secondary)',
                          borderBottom:
                            idx < caseStudy.intervention.points.length - 1
                              ? '1px solid rgba(124,107,196,0.1)'
                              : 'none',
                          paddingBottom:
                            idx < caseStudy.intervention.points.length - 1 ? '6px' : '0',
                        }}
                      >
                    ...
                    {caseStudy.results.points.map((point, idx) => (
                      <li
                        ...
                        style={{
                          color: 'var(--text-secondary)',
                          borderBottom:
                            idx < caseStudy.results.points.length - 1
                              ? '1px solid rgba(124,107,196,0.1)'
                              : 'none',
              ...
              <div
                ...
                style={{ borderColor: 'rgba(124,107,196,0.1)' }}
              >
                <button
        ...
        >
          ...
          >
            {language === 'es'
              ...
              : 'Each transformation requires a unique approach.'}
