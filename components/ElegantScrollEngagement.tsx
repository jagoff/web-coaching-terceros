    ...
    <section ref={ref} className="relative py-24 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-gray-100/90 text-4xl md:text-6xl font-light">que transforma</span>
        </motion.h2>
        ...
        >
          Más de dos décadas transformando líderes y organizaciones a través de metodologías ágiles
          y un enfoque human-centric
        </motion.p>
