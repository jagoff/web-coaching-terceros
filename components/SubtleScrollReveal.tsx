  ...
  return (
    <section ref={ref} className="relative py-32">
      ...
      >
        ...
        >
          <span className="text-gray-100/80">Transformación</span>
          <br />
        ...
        >
          Un enfoque human-centric que combina metodologías ágiles con liderazgo estratégico para
...
function SubtleCard({
  ...
  return (
    ...
    >
      ...
      {/* Título */}
      <h3 className="text-xl md:text-2xl font-light text-gray-300/80 mb-4">{title}</h3>

      {/* Descripción */}
      <p className="text-gray-400/50 leading-relaxed">{description}</p>
