...
export default function Navbar() {
    ...
    const handleScroll = () => {
      ...
      if (shouldHide) {
        if (visibleRef.current) {
          logger.info('Navbar hiding - near contact section', {
            component: 'Navbar',
            data: { scrollY: currentScrollY },
          })
        ...
        if (!visibleRef.current) {
          logger.info('Navbar showing - scrolling up', {
            component: 'Navbar',
            data: { scrollY: currentScrollY },
          })
  ...
  const handleLinkClick = (href: string) => {
    ...
    if (
      href.includes('/sobre-mi') ||
      href.includes('/servicios') ||
      href.includes('/testimonios') ||
      href.includes('/faq')
    ) {
      setVisible(false)
      ...
      >
        <motion.div
          ...
          style={{
            ...
            background: 'linear-gradient(90deg, #7C6BC4 0%, #C87B5A 60%, #FF6B35 100%)',
          }}
          suppressHydrationWarning={true}
        />
      </div>
              ...
              <div className="flex items-center justify-between gap-8">
                ...
                <div className="lg:hidden flex items-center gap-8">
                  ...
                  <button
                    ...
                    aria-label={
                      language === 'es' ? 'Cambiar idioma a inglés' : 'Change language to Spanish'
                    }
                  >
