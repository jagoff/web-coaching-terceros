...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    about: {
      ...
      intro: '<span style="font-family: var(--font-modern); font-weight: 600;">Hola! Soy <span class="web-underline" style="background: linear-gradient(135deg, #FF6B35 0%, #C87B5A 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; position: relative; display: inline;">Fernando Ferrari</span> llevo más de 20 años en tecnología — desde infraestructura y operaciones hasta liderazgo estratégico y transformación cultural. Fui técnico, sysadmin, CTO, Advanced Scrum Master, Product Owner, PM, Director de Operaciones. Lideré equipos en empresas de más de 2500 personas como tambien en empresas de 4 personas, acompañé startups a escalar sin perder su identidad. Hoy gestiono infraestructura AWS Cloud en Avature, co-fundé Nodok.AI para proyectos de inteligencia artificial, y llevo 11 años como consultor ágil independiente. — <span style="font-family: var(--font-heading); font-style: italic; color: var(--text-primary);">Te acompaño a construir equipos que funcionen sin vos encima, procesos que escalen, y una cultura donde la gente quiera quedarse.</span>',
      approach: '',
