...
export const translations: Record<Language, Translations> = {
  ...
  <p style="margin-bottom: 1rem; max-width: 100%; overflow-wrap: break-word;">
    <span style="font-family: var(--font-serif); font-weight: 500; display: block;">Llevo más de 20 años en tecnología — desde infraestructura y operaciones hasta liderazgo estratégico y transformación cultural.</span>
  </p>
  ...
  <p style="margin-top: 1.2rem; padding-left: 0.8rem; border-left: 3px solid var(--gold-primary); max-width: 100%; overflow-wrap: break-word;">
    <span style="font-family: var(--font-heading); font-style: italic; font-weight: 500; color: var(--text-primary); display: block;">Te acompaño a construir <span style="font-weight: 700;">equipos autónomos</span>, <span style="font-weight: 700;">procesos que escalen</span>, y una <span style="font-weight: 700;">cultura que retenga y desafíe al talento</span>.</span>
  </p>
</div>`,
      approach: '',
    ...
    services: {
      ...
      subtitle:
        'Cada organización es única. Yo adapto mis servicios a tus necesidades específicas, combinando frameworks probados con enfoque personalizado.',
      ...
      items: {
        ...
        organizacional: {
          ...
          description:
            'Para startups y empresas que necesitan profesionalizar operaciones, adoptar agilidad real y construir una cultura que escale junto con el negocio. Yo te acompaño en este proceso.',
          benefits: [
        ...
        frameworks: {
          ...
          description:
            'Para equipos que necesitan herramientas concretas y probadas. Instalo OKRs, ceremonias ágiles, matrices de decisión y dashboard de métricas para que tu equipo funcione de inmediato.',
          benefits: [
        ...
        ambos: {
          ...
          description:
            'Un enfoque integral que combina coaching de liderazgo con consultoría organizacional para tu transformación completa y sostenible. Yo te guío en todo el camino.',
          benefits: [
    ...
    process: {
      ...
      steps: {
        diagnostico: {
          title: 'Diagnóstico',
          description:
            'Analizo tu organización, equipo o liderazgo actual. Identifico fricciones, oportunidades y el punto de partida real.',
        },
        diseno: {
          title: 'Diseño',
          description:
            'Co-creo una hoja de ruta a medida: objetivos claros, métricas de avance y estrategia ágil adaptada a tu contexto.',
        },
        ejecucion: {
          title: 'Ejecución',
          description:
            'Sesiones de coaching y acompañamiento en el día a día. Itero, remuevo impedimentos y mantenemos el foco.',
        },
        autonomia: {
          title: 'Autonomía',
          description:
            'Consolido prácticas, transfiero herramientas y construís la capacidad interna para seguir evolucionando sin depender de mí.',
        },
      },
    },
    ...
    pricing: {
      ...
      title2: 'plan ideal',
      subtitle:
        'Cada plan está diseñado para diferentes necesidades. Yo te ayudo a encontrar cuál se adapta mejor a vos.',
      ...
      plans: {
        ...
        personalizado: {
          ...
          period: '',
          description:
            'Soluciones integrales a medida para tu organización. Yo diseño el plan perfecto para vos.',
          features: [
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            'Team Autonomy Score (0-100), Tiempo de Latencia de Decisiones, Ratio de Eficiencia de Reuniones, Tasa de Reducción de Dependencias, Índice de Velocidad de Innovación. Se mide línea base mensual y seguimiento semanal durante el proceso.',
        },
        {
          question: '¿Cuál es el ROI esperado de un programa de 12 semanas?',
          answer:
            'Promedio histórico: 3x inversión en 6 meses. Reducción de reuniones 60%, velocidad de despliegue +200%, rotación de empleados -45%, satisfacción del equipo +40%. Métricas validadas con 50+ equipos.',
        },
        {
          question: '¿Qué herramientas y frameworks se implementan?',
          answer:
            'OKRs (Objectives and Key Results), Ceremonias Ágiles (daily, retrospective, planning), Matriz de Decisiones (RACI, DACI), Team Topologies, Sociocracy 3.0, Dashboard de Métricas (KPIs personalizados), Herramientas de Automatización de Procesos.',
        },
        {
          question: '¿Cómo funciona el modelo de pricing para consultoría organizacional?',
          answer:
            'Modelo basado en valor: USD 200/hora para diagnóstico, USD 150/hora para implementación, opción de retainer mensual USD 2,500 para equipos 5-10 personas. Precios ajustables según tamaño y complejidad.',
        },
        {
          question: '¿Qué certificaciones y experiencia tiene el coach?',
          answer:
            '20+ años en liderazgo tecnológico, Advanced Certified ScrumMaster, Advanced Certified Scrum Product Owner, Management 3.0, unFIX Foundation. Experiencia en empresas de 4 a 2500+ personas, co-fundador de Nodok.AI, +10 años como consultor ágil independiente.',
        },
        {
          question: '¿Qué resultados específicos se pueden esperar en 3 meses?',
          answer:
            'Semana 1-4: Evaluación completa y diseño de framework. Semana 5-8: Primer ciclo de implementación con métricas base. Semana 9-12: Patrones de escalamiento y validación de ROI. Resultados típicos: 30% reducción en latencia de decisiones, 50% aumento en iniciativas del equipo.',
        },
      ],
    },
    ...
    footer: {
      description:
        'Transformando líderes y organizaciones a través del coaching ágil y la transformación estratégica.',
      navLinks: {
        sobreMi: 'Sobre mí',
        servicios: 'Servicios',
        metodo: '¡Tenes que vivirlo!',
    ...
    testCard: {
      title: 'Test de',
      subtitle:
        'Evalúa el nivel de madurez de tu organización en 5 áreas clave y obtén un plan de acción personalizado.',
    ...
    forWho: {
      ...
      titleHighlight: '',
      subtitle:
        'Acompaño a <strong>líderes tech y founders</strong> que están en momentos clave. Si alguna de estas situaciones te resuena, podemos trabajar juntos.',
  ...
  en: {
    ...
    about: {
      ...
      intro:
        '<div style="line-height: 1.6; font-size: 0.85rem; max-width: 100%; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; hyphens: auto; margin: 0; padding: 0 0.5rem; box-sizing: border-box; width: 100%;"><p style="margin-bottom: 1.2rem; max-width: 100%; overflow-wrap: break-word;"><span style="font-family: var(--font-modern); font-weight: 600; background: linear-gradient(135deg, #ff6b35, #f7931e, #ffcc00); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; font-size: 1rem; display: block; margin-bottom: 0.5rem;">I\'m Fernando Ferrari.</span></p><p style="margin-bottom: 1rem; max-width: 100%; overflow-wrap: break-word;"><span style="font-family: var(--font-modern); font-weight: 500; display: block;">I\'ve been in technology for over 20 years — from infrastructure and operations to strategic leadership and cultural transformation.</span></p><p style="margin-bottom: 1rem; max-width: 100%; overflow-wrap: break-word;"><span style="font-family: var(--font-modern); font-weight: 500; display: block;">I\'ve been technician, sysadmin, CTO, Advanced Scrum Master, Product Owner, PM, Operations Director.</span></p><p style="margin-bottom: 1rem; max-width: 100%; overflow-wrap: break-word;"><span style="font-family: var(--font-modern); font-weight: 500; display: block;">I\'ve led teams in companies with more than <span style="color: #7C6BC4; font-weight: 700;">2500 people</span> as well as 4-person companies, helping startups scale without losing their identity.</span></p><p style="margin-bottom: 1rem; max-width: 100%; overflow-wrap: break-word;"><span style="font-family: var(--font-modern); font-weight: 500; display: block;">Today I manage AWS Cloud infrastructure at Avature, co-founded <span style="color: #7C6BC4; font-weight: 700;">Nodok.AI</span> for AI projects, and have +10 years as an independent agile consultant.</span></p><p style="margin-top: 1.2rem; padding-left: 0.8rem; border-left: 3px solid var(--gold-primary); max-width: 100%; overflow-wrap: break-word;"><span style="font-family: var(--font-heading); font-style: italic; color: var(--text-primary); display: block;">I help you build <span style="font-weight: 700;">autonomous teams</span>, <span style="font-weight: 700;">scalable processes</span>, and a <span style="font-weight: 700;">culture that retains talent</span>.</span></p></div>',
      approach: '',
    ...
    services: {
      ...
      subtitle:
        'Every organization is unique. I adapt my services to your specific needs, combining proven frameworks with personalized approach.',
      ...
      items: {
        ...
        organizacional: {
          ...
          description:
            'For startups and companies that need to professionalize operations, adopt real agility, and build a culture that scales with the business. I accompany you in this process.',
          benefits: [
        ...
        frameworks: {
          ...
          description:
            'For teams that need concrete and proven tools. I install OKRs, agile ceremonies, decision matrices and metrics dashboards so your team works immediately.',
          benefits: [
            'OKRs (Objectives and Key Results)',
        ...
        ambos: {
          title: 'Both services',
          description:
            'A comprehensive approach that combines leadership coaching with organizational consulting for your complete and sustainable transformation. I guide you through the entire journey.',
          benefits: [
    ...
    process: {
      ...
      steps: {
        diagnostico: {
          title: 'Diagnosis',
          description:
            'I analyze your current organization, team, or leadership. I identify friction points, opportunities, and the real starting point.',
        },
        diseno: {
          title: 'Design',
          description:
            'I co-create a tailored roadmap: clear objectives, progress metrics, and an agile strategy adapted to your context.',
        },
        ejecucion: {
          title: 'Execution',
          description:
            'Coaching sessions and day-to-day support. I iterate, remove impediments, and maintain focus.',
        },
        autonomia: {
          title: 'Autonomy',
          description:
            'I consolidate practices, transfer tools, and build internal capacity to continue evolving without depending on me.',
        },
      },
    },
    ...
    pricing: {
      ...
      plans: {
        ...
        personalizado: {
          ...
          period: '',
          description:
            'Comprehensive solutions tailored to your organization. I design the perfect plan for you.',
          features: [
            'No-charge diagnosis',
    ...
    footer: {
      description:
        'Transforming leaders and organizations through agile coaching and strategic transformation.',
      navLinks: {
        sobreMi: 'About me',
        servicios: 'Services',
        metodo: 'You have to experience it!',
    ...
    testCard: {
      title: 'Maturity Test',
      subtitle:
        "Evaluate your organization's maturity level in 5 key areas and get a personalized action plan.",
    ...
    whatsapp: {
      message:
        'Hi! I want to schedule a free coaching session. What dates and times do you have available?',
    ...
    forWho: {
      ...
      titleHighlight: '',
      subtitle:
        'I work with tech leaders and founders at key moments. If any of these situations resonate with you, we can work together.',
      ...
      profiles: [
        {
          ...
          description:
            "You went from writing code to leading people and nobody taught you how. Technically you're strong, but the human and organizational side still weighs on you.",
        ...
        },
        {
          ...
          description:
            'What worked with 5 people no longer cuts it with 20. The team loses coordination, priorities clash, and the speed you had before is gone.',
        ...
        },
        {
          ...
          description:
            "There's talent, but no delivery. Silos appear, ownership is missing, decisions don't get made. You know the problem isn't technical — and that makes it harder to solve.",
