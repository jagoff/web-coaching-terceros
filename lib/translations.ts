...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    about: {
      ...
      intro: '<span style="font-family: var(--font-modern); font-weight: 600; color: var(--gold-primary);">Soy Fernando.</span> Más de 20 años en tecnología — desde infraestructura y operaciones hasta liderazgo estratégico y transformación cultural.\n\n<span style="font-family: var(--font-modern); font-weight: 500;">Fui técnico, sysadmin, CTO, Advanced Scrum Master, Product Owner, PM, Director de Operaciones.</span> Lideré equipos en empresas de más de 2500 personas y acompañé startups a escalar sin perder su identidad. Hoy gestiono infraestructura AWS Cloud en Avature, co-fundé Nodok.AI para proyectos de inteligencia artificial, y llevo 11 años como consultor ágil independiente.\n\n— <span style="font-family: var(--font-heading); font-style: italic; color: var(--text-primary);">Te acompaño a construir equipos que funcionen sin vos encima, procesos que escalen, y una cultura donde la gente quiera quedarse.</span>',
      approach: '',
