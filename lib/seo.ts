...
export const seoDataByRoute: Record<string, SEOData> = {
  ...
  "/servicios": {
    ...
    ogDescription: "Descubrí nuestros servicios de coaching de liderazgo y consultoría agile para transformar tu equipo tech.",
    ogImage: "https://eleva-consultoria.com/opengraph-image.png",
  ...
  "/sobre-mi": {
    ...
    description: "Conocé mi trayectoria de +20 años en tecnología, coaching agile y consultoría para líderes tech y startups en Argentina y Latinoamérica.",
    ogTitle: "Sobre Mí | Fernando Ferrari | ELEVA CONSULTORIA",
    ogDescription: "+20 años de experiencia en tecnología, coaching agile y consultoría para líderes tech.",
    ogImage: "https://eleva-consultoria.com/opengraph-image.png",
    canonical: "https://eleva-consultoria.com/sobre-mi",
    keywords: ["Fernando Ferrari", "sobre mí", "trayectoria", "experiencia tecnología", "coaching agile", "consultoría Argentina"],
    locale: "es_AR",
    type: "website",
  },
  "/testimonios": {
    title: "Testimonios de Clientes | Coaching y Consultoría | ELEVA CONSULTORIA",
    description: "Historias de éxito de líderes tech y startups que transformaron sus equipos con nuestra metodología de coaching y consultoría.",
    ogTitle: "Testimonios de Clientes | Coaching y Consultoría | ELEVA CONSULTORIA",
    ogDescription: "Descubrí las historias de éxito de nuestros clientes en coaching y consultoría tech.",
    ogImage: "https://eleva-consultoria.com/opengraph-image.png",
    canonical: "https://eleva-consultoria.com/testimonios",
    keywords: ["testimonios", "historias éxito", "clientes coaching", "resultados consultoría", "casos éxito", "coaching tech"],
    locale: "es_AR",
    type: "website",
  },
  "/madurez-empresarial": {
    title: "Test de Madurez Empresarial | Evaluación Gratuita | ELEVA CONSULTORIA",
    description: "Evaluá gratuitamente la madurez empresarial de tu organización. Descubrí áreas de mejora y recibe recomendaciones personalizadas.",
    ...
    keywords: ["test madurez", "evaluación empresarial", "diagnóstico organizacional", "madurez empresarial", "evaluación gratuita", "consultoría empresas"],
    locale: "es_AR",
    type: "website",
  },
};
