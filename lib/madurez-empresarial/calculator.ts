  ...
  static getLevelInfo(level: MadurezLevel): {
    ...
    const levelInfo = {
      inicial: {
        title: 'Nivel Inicial',
        description:
          'Tu organización está comenzando su journey de madurez. Hay grandes oportunidades de mejora.',
        color: 'red',
        icon: '🌱',
      },
      desarrollo: {
        title: 'En Desarrollo',
        description:
          'Tu organización tiene bases sólidas y está en proceso de optimización continua.',
        color: 'yellow',
        icon: '🌿',
      },
      maduro: {
        title: 'Nivel Maduro',
        description:
          'Tu organización opera con eficiencia y está lista para alcanzar la excelencia.',
        color: 'blue',
        icon: '🌳',
      },
      excelencia: {
