...
test.describe('Formulario de Contacto', () => {
  ...
  test('debería mostrar check de validación en nombre completo cuando es válido', async ({
    page,
  }) => {
  ...
  test('debería mostrar check de validación en mensaje cuando es válido', async ({ page }) => {
    ...
    await mensajeInput.fill(
      'Este es un mensaje de prueba con más de 10 caracteres para cumplir con la validación mínima requerida.'
    )
  ...
  test('debería mostrar checks en la posición correcta (esquina inferior izquierda)', async ({
    page,
  }) => {
    ...
    await page
      ...
      .fill('Este es un mensaje de prueba con más de 10 caracteres.')
  ...
  test('debería mostrar errores de validación cuando los campos son inválidos', async ({
    page,
  }) => {
  ...
  test('debería habilitar el botón de envío cuando todos los campos son válidos', async ({
    page,
  }) => {
    // Llenar todos los campos válidos
    await page.locator('input[name="nombre"]').fill('Juan Pérez')
