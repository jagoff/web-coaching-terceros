...
test.describe('Case Studies Modal Debug', () => {
  ...
  test('modal should open and close correctly', async ({ page }) => {
    ...
    console.log(`📋 Modal sections - ANTES: ${antesSection}, INTERVENCIÓN: ${intervencionSection}, RESULTADOS: ${resultadosSection}`);
  ...
  test('modal should show all points (not limited)', async ({ page }) => {
    ...
    const antesPointsInModal = await modalContent.locator('text=ANTES').locator('..').locator('li').count();
